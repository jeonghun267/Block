...
import { runRuntimeTick, type RuntimeEnvironment } from "../lib/runtime/orchestrator";
...
const worker = {
  ...
  async scheduled(controller: ScheduledController, env: Env, ctx: ExecutionContext): Promise<void> {
    ...
    ctx.waitUntil(runRuntimeTick(env as unknown as RuntimeEnvironment, { now: scheduledAt }).catch((error: unknown) => {
